window.InitUserScripts = function() {
  window.Script1 = function() {
    var ls1 = localStorage.getItem("emotionalAgilityQuiz") || "(no response saved)";
    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          page.drawText("New Leader Session 2 3/4 AIM", {
            x: margin, y: y, size: 21, font: fontBold, color: NAVY
          });
          y -= 22;
          page.drawText("New leader programme  ·  Session 2  · 3/4  " + dateStr, {
          ...
          var exercises = [
            {
              ...
              intro: "When asked to reflect on your experiences at work both as a leader and an employee, you rated yourself on a self assessment. This was your result.",
              response: ls1
            }
          ];
          ...
          return pdfDoc.save().then(function(pdfBytes) {
            ...
            a.href     = url;
            a.download = "New Leader Session 2 3/4 AIM.pdf";
