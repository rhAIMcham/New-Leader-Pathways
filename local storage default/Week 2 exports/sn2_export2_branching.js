    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          page.drawText("New Leader Session 2 2/4 AIM", {
            x: margin, y: y, size: 21, font: fontBold, color: NAVY
          });
          y -= 22;
          page.drawText("New leader programme  ·  Session 2  · 2/4  " + dateStr, {
          ...
          var exercises = [ 
            {
              title: "Your choices",
              intro: "Below is a record of the choices you made in the branching scenario following Sam's sudden absence.",
              response: dtWhole
            },
            {
              title: "Question 1",
              intro: "What decision gave the strongest emotional response and how did these emotions influence the decisions you made?",
              response: dt1
            },
            {
              title: "Question 2",
              intro: "Reflect on your choices throughout the activity. Were there any points where you could have paused, reframed the situation, or responded differently? How might this have changed the outcome for you or your team?",
              response: dt2
            },
            {
              title: "Question 3",
              intro: "What strategies from this module, such as emotional self-management or delegation, would you use to better manage a situation like this in the future?",
              response: dt3
            }
          ];
          ...
          for (var p = 0; p < total; p++) {
            ...
            pg.drawText("New leader program 2/4", {
              x: margin,
              y: 32,
              size: labelSize,
              font: font,
          ...
          return pdfDoc.save().then(function(pdfBytes) {
            ...
            a.href     = url;
            a.download = "New Leader Session 2 2/4 AIM.pdf";
