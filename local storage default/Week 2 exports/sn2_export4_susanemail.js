window.InitUserScripts = function() {
  window.Script1 = function() {
    var ls1 = localStorage.getItem("learnerReplyEmailWeek2") || "(no response saved)";
    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          page.drawText("New Leader Session 2 4/4 AIM", {
            x: margin, y: y, size: 21, font: fontBold, color: NAVY
          });
          y -= 22;
          page.drawText("New leader programme  ·  Session 2  · 4/4  " + dateStr, {
          ...
          var exercises = [
            {
              title: "Replying to Susan's email.",
              intro: "At the end of your second week, Susan sent you another email following up on how you have been progressing. She asked about your ability to handle stress, and your experiences being managed by someone with poor stress management techniques. She encouraged you to practice reframing concepts to help reduce frustration in the workplace.",
              response: ls1
            }
          ];
          ...
          for (var p = 0; p < total; p++) {
            ...
            pg.drawText("New leader program 4/4", {
              x: margin,
              y: 32,
              size: labelSize,
              font: font,
          ...
          return pdfDoc.save().then(function(pdfBytes) {
            ...
            a.href     = url;
            a.download = "New Leader Session 2 4/4 AIM.pdf";
