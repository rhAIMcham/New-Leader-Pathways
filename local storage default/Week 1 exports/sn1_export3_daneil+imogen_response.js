window.InitUserScripts = function() {
  window.Script1 = function() {
       var daniel1 = localStorage.getItem("DanielChoice") || "(no response saved)";
    var daniel2 = localStorage.getItem("DanielResponse") || "(no response saved)";
    var imogen1 = localStorage.getItem("ImogenChoice") || "(no response saved)";
    var imogen2 = localStorage.getItem("ImogenResponse") || "(no response saved)";
    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          page.drawText("New Leader Session 1 3/6 AIM", {
            x: margin, y: y, size: 21, font: fontBold, color: NAVY
          });
          y -= 22;
          page.drawText("New leader programme  ·  Session 1  · 3/6  " + dateStr, {
          ...
          // ✏️ Update titles, intro text, and reflection prompt to match your exercises
            var exercises = [
            {
              title: "Response to Daniel",
              intro: "In this interaction, you listened to a voicemail Daniel had left. You selected the below response.",
              response: daniel1
            },
            {
              title: "Daniel's reaction",
              intro: "Daniel replied to your message with the below response.",
              response: daniel2
            },
            {
              title: "Response to Imogen",
              intro: "In this interaction, you listened to a voicemail Imogen had left. You selected the below response.",
              response: imogen1
            },
            {
              title: "Imogen's reaction",
              intro: "Imogen replied to your message with the below response.",
              response: imogen2
            }            
          ];
          ...
          for (var p = 0; p < total; p++) {
            ...
            pg.drawText("New leader program 3/6", {
              x: margin,
              y: 32,
              size: labelSize,
              font: font,
          ...
          return pdfDoc.save().then(function(pdfBytes) {
            ...
            a.href     = url;
            a.download = "New Leader Session 1 3/6 AIM.pdf";
