window.InitUserScripts = function() {
  window.Script1 = function() {
    var chayaEmail = localStorage.getItem("chayaEmailSent") || "(no response saved)";
    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          var exercises = [
            {
              title: "Managing across teams",
              intro: "In this activity you were asked to respond to another manager requesting one of your team members for a task. You needed to select the appropriate tone and level of professionalism while still communicating your point.",
              response: chayaEmail
            }
          ];
