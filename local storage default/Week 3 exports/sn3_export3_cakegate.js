    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          page.drawText("New Leader Session 3 3/4 AIM", {
            x: margin, y: y, size: 21, font: fontBold, color: NAVY
          });
          y -= 22;
          page.drawText("New leader programme  ·  Session 3  · 3/4  " + dateStr, {
          ...
          var exercises = [
            {
              title: "Emailing Imogen",
              intro: "In this activity, you were asked to send an email to your team member Imogen following her disagreement with a colleague regarding cake in the staff fridge. You were provided chat logs showing how the argument had escalated, and are informed by Kannika's manager that they will be discussing her behaviour privately. Your only focus in speaking with Imogen.",
              response: cakegate
            }
          ];
          ...
          for (var p = 0; p < total; p++) {
            ...
            pg.drawText("New leader program 3/4", {
              x: margin,
              y: 32,
              size: labelSize,
              font: font,
          ...
          return pdfDoc.save().then(function(pdfBytes) {
            ...
            a.href     = url;
            a.download = "New Leader Session 3 3/4 AIM.pdf";
