    ...
    function buildAndDownload() {
      ...
      PDFLib.PDFDocument.create().then(function(pdfDoc) {
        ...
        return Promise.all([
          ...
          var exercises = [
            {
              title: "Your final email from Susan",
              intro: "In this activity, Susan emailed you congratulating you on completing the third week of your new role. She prompted you to reflect on the tasks you have completed, on what went well and what could have gone better. Your email is below.",
              response: motivationEmail
            }
          ];
